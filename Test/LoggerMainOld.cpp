...
int main() {
    ...
    LOG_OLD(CustomerLogLevel::INFO, "This is an info message.");
    LOG_OLD(CustomerLogLevel::WARN, "This is a warning message.");
    // This DEBUG message will not be printed.
    LOG_OLD(CustomerLogLevel::DEBUG, "This is a debug message and should NOT appear.");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "This debug message should now appear.");
    LOG_OLD(CustomerLogLevel::INFO, "This info message should also appear.");
    LOG_OLD(CustomerLogLevel::WARN, "This warning message should also appear.");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "This debug message should NOT appear.");
    LOG_OLD(CustomerLogLevel::INFO, "This info message should NOT appear.");
    LOG_OLD(CustomerLogLevel::WARN, "This warning message SHOULD appear.");
    LOG_OLD(CustomerLogLevel::ERROR, "This error message should NOT appear.");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "This debug message should NOT appear.");
    LOG_OLD(CustomerLogLevel::INFO, "This info message should NOT appear.");
    LOG_OLD(CustomerLogLevel::WARN, "This warning message should NOT appear.");
    LOG_OLD(CustomerLogLevel::ERROR, "This error message SHOULD appear.");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "This debug message should NOT appear.");
    LOG_OLD(CustomerLogLevel::INFO, "This info message should appear.");
    LOG_OLD(CustomerLogLevel::WARN, "This warning message should appear.");
    LOG_OLD(CustomerLogLevel::ERROR, "This error message should appear.");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::INFO, "This INFO message is being written to the log file.");
    LOG_OLD(CustomerLogLevel::ERROR, "This ERROR message should NOT be written to the file.");
    ...
    LOG_OLD(CustomerLogLevel::INFO, "This info message uses the custom format and exact level.");
    LOG_OLD(CustomerLogLevel::WARN, "This warning should NOT appear due to exact level filtering.");
    ...
    LOG_OLD(CustomerLogLevel::INFO, "This message is now on the console with exact level filtering.");
    LOG_OLD(CustomerLogLevel::DEBUG, "This debug message should NOT appear.");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "DEBUG message - should appear");
    LOG_OLD(CustomerLogLevel::INFO, "INFO message - should NOT appear (excluded)");
    LOG_OLD(CustomerLogLevel::WARN, "WARN message - should appear");
    LOG_OLD(CustomerLogLevel::ERROR, "ERROR message - should appear");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "DEBUG message - should appear");
    LOG_OLD(CustomerLogLevel::INFO, "INFO message - should NOT appear (excluded)");
    LOG_OLD(CustomerLogLevel::WARN, "WARN message - should NOT appear (excluded)");
    LOG_OLD(CustomerLogLevel::ERROR, "ERROR message - should appear");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "DEBUG message - should appear");
    LOG_OLD(CustomerLogLevel::INFO, "INFO message - should appear (included back)");
    LOG_OLD(CustomerLogLevel::WARN, "WARN message - should NOT appear (still excluded)");
    LOG_OLD(CustomerLogLevel::ERROR, "ERROR message - should appear");
    std::cout << std::endl;
    ...
    LOG_OLD(CustomerLogLevel::DEBUG, "DEBUG message - should NOT appear (below min level)");
    LOG_OLD(CustomerLogLevel::INFO, "INFO message - should appear");
    LOG_OLD(CustomerLogLevel::WARN, "WARN message - should NOT appear (excluded)");
    LOG_OLD(CustomerLogLevel::ERROR, "ERROR message - should appear");
    std::cout << std::endl;
